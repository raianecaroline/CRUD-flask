...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:123456@localhost/youtube'
...
def seleciona_usuario(id):
    ...
    usuario_json = usuario_objeto.to.json()
...
def atualiza_usuario(id):
    usuario_objeto = Usuario.query.filter_by(id=id).first() # pega o usuario
    ...
    try:
        ...
        if ('email' in body):
            usuario_objeto.emial = body['email']
